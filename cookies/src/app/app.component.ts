...
export class AppComponent {
  ...
  productsData = [
    {
      image: '1.png',
      title: 'Лучшие друзья',
      text: 'Печенье, c которого все началось! Наше фирменное печенье c шоколадной крошкой и грецкими орехами хрустящее снаружи c достаточно толстой и липкой серединкой.',
      price: 20,
      basePrice: 20,
      weight: '2 шт./ 200 гр.',
    },
    ...
    },
    {
      ...
      text: 'ам больше не нужно выбирать фаворитов. Мы сделали этот набор для всех людей, которые действительно любят шоколад…',
      price: 38,
      basePrice: 38,
      weight: '4 шт./ 400 гр.',
    },
 ...
 }  //scroll to verschiedene el von versch.el
